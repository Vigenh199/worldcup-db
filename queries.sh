...
echo "$($PSQL "SELECT name FROM games LEFT JOIN games_teams USING(game_id) LEFT JOIN teams USING(team_id) WHERE year=2014 AND round='Eighth-Final' ORDER BY name;")"
